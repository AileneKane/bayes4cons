...
\begin{itemize}
   ...
   \item Bayesian Data Analysis by Gelman et al.
    \item Bayesian Models: A statistical primer for ecologists by Hobbs & Hooten
    \item Ecological Forecasting by Dietz
\item Statistical Rethinking by Richard McElreath \url{https://xcelab.net/rm/}
...
\item The Stan Forums \url{https://discourse.mc-stan.org/}
...
\par Bayesian workflow:
\begin{itemize}
 \item Bayesian Workflow \citep{gelman2020bayesia}
\item Visualization in Bayesian Workflow \url{https://doi.org/10.1111/rssa.12378} % add ref? 
\item  A four-step Bayesian workflow for improving ecological science \url{https://doi.org/10.48550/arXiv.2408.02603}
\end{itemize}

\par Bayesian case studies: 
\begin{itemize}
...
\item Stan Prior Recommendations \url{https://github.com/stan-dev/stan/wiki/Prior-Choice-Recommendations}
 ...
 \begin{itemize}
 \item \href{https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecm.1314}{A guide to Bayesian model checking for ecologists \citep{conn2018guide}} % emw15Nov2025: I personally dislike this paper -- be sure to read it before you cite it...
 \item 
