...
%emw1Nov: First two sentences don't fully work for me and second sentence interrupts connection between first and third sentences ... Perhaps just open with: Conservation science was founded as a field aimed at conserving biodiversity, and its associated benefits. Climate change has layered an additional challenge because it both affects biodiversity and is .... 
...
%emw1Nov:  consider cutting down to maybe three short sentences once contents of paper are more set? I am happy to offer suggested edits whenever you want. 
...
%emw1Nov: I suggest we either explain WHY conservation biologists need these alternative approaches or just jump quicker into adaptive management. 
