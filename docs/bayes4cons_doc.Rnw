...
\affil[5]{UKY}
\affil[6]{University of Toronto}
\affil[7]{SFU}
\affil[8]{Multiple other institutions?}
...
%MAM:I feel we could get to Bayesian statistics (and/or more clearly the need for mechanistic models) in the first paragraph. I would merge the first two paragraph, and condense some of the more general climate change biodiversity crisis stuff.
