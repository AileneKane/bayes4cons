...
\date{\today}
\maketitle 
\textbf{Author contributions}: All authors conceived of this manuscript, which began through conversations at a Bayesian Generative Modelling Symposium at University of British Columbia in 2024 designed by EMW with funding from UBC's Grants for Catalyzing Research Clusters: Biodiversity Research; AKE led the writing of the manuscript, HNE, EMW, DL, and AKE made figures; all authors contributed portions of text, and revised the manuscript.

\textbf{Data Accessibility} All data and code are included as supplemental materials and available on GitHub

\textbf{Running title} Conservation science using Bayesian methods

\textbf{Key words} biodiversity, climate change, statistics, adaptive management
...
\section*{Abstract} 
% emw15Nov2025: see re-write of some long sentences below led me to cut 'to address the biodiversity crisis in the era of climate change' -- see if you can sneak it elsewhere? Maybe as a new sentence after the first one? %HNE16nov2025: added phrase in last sentence, and split last sentence into two sentences. Not sure if it works or not? Overall, I like that the abstract is short. 

Conservation science has been called a `crisis discipline' in which practitioners, like medical doctors, often need to act quickly to sustain the long-term health of nature, but without complete knowledge. Bayesian data analysis provides a framework to support evidence-based conservation science, but has not been fully integrated into conservation policy and practice globally. We highlight features of Bayesian data analysis that are well-suited to help practitioners who may be unfamiliar with Bayesian methods, including the iterative workflow process, flexible modelling frameworks, and integration of uncertainty. We also review recent trends in the use of Bayesian approaches across subfields of conservation science and share resources to facilitate wider implementation of these methods. By highlighting the utility of Bayesian data analytical approaches, we hope to accelerate their adoption to address the biodiversity crisis in the era of climate change. We contend that these methods can lead to more rigorous evidence-based research and, ultimately, improved conservation outcomes. 
\newpage
\section* {Introduction}

Conservation science is an interdisciplinary field focused on protecting and managing biodiversity and natural ecosystems, both to sustain the long-term health of nature and to benefit human well-being \citep{kareiva2012conservation}. At its start, conservation science often focused on spatial analyses to identify priority areas to establish parks and preserves intended to protect threatened species and communities \citep{bocking2020science}. 
% emw15Nov2025: Can we simplify below sentence? I am also not sure what 'preserve establishment' means 
%HNE16Nov2025: shortend and simplified below sentence. 
Today, climate change has added new feedbacks and complexity to these analyses, since protecting today's habitats from development or other land use changes does not guarantee suitable conditions in a future warmer world. In addition, climate change both affects biodiversity \citep[e.g., by causing extinctions][]{urban2024climate} and is affected by biodiversity conservation \citep[e.g., nature-based climate solutions or `natural climate solutions'][]{griscom2017natural}. Integrating approaches to bolster adaptation and resilience to climate change, as well as greenhouse gas mitigation, are critical components of planning and implementing conservation in the era of climate change.

% emw15Nov2025: Any chance you could cut some of the previous paragraph and fit this point into the first paragraph also?
\par Robust and usable conservation science under climate change is needed at scales ranging from local to global. For example, preserve managers seek guidance about how to best steward natural resources for climate resilience \citep{Nadeau2015}, and  international climate policymakers rely on scientific data and publications for systematic observation of climate systems and impacts to people \cite{ipcc2007}. 

% emw15Nov2025: too many sentences in the main text are identical to abstract for me -- I like the ones you've picked, I just think they need to be less identical. 
\par As `crisis discipline' practitioners, conservation biologists, like medical doctors, often need to act rapidly and without complete knowledge \citep{soule1985conservation}. Rather than relying only on personal experience or word of mouth in such situations, as was frequently done in the past, medical and conservation practitioners alike increasingly rely on evidence that has been systematically accumulated through meta-analyses and other syntheses \citep{kareiva2012conservation}. Developing the evidence base for urgent climate and biodiversity problems often requires synthesizing multiple data sources and incomplete datasets, given the complex ecological systems in which many conservation science problems are grounded. A critical part of building this evidence base is ensuring reproducibility and transparency, including clear communication of uncertainty \citep{ellis2024principles,ipcc2007}. 

\par Addressing conservation problems requires information beyond ecology; social, cultural, political and economic data, in addition to biological and physical information, are needed to provide the evidence base upon which decisions can be made \citep{Bennett2017}. Focal populations of threatened species are often small, and ecological and social data are often non-normal, `unbalanced' and nested within hierarchical or non-hierarchical groupings that are non-independent (e.g., species or other groupings related to evolutionary history/genetics, spatial clustering such as plots or sites, or temporal clustering such as day or year). These qualities challenge many traditional, commonly used statistical approaches (e.g., analysis of variance). Further, conservation evidence comes in many forms, including from quantitative studies of people and nature, community knowledge \citep{Brook2008LEK}, expert knowledge \citep{Martin2012}, Indigenous knowledge \citep[e.g.,][]{gryba2023indigenous}, and others. Conservation decision-making requires integrating these multiple sources of information to provide an evidence base for decision-making \citep{stern2022interweaving}. 

\par Bayesian data analysis provides a framework and suite of approaches that support these needs of conservation science in the 21st century. Bayesian approaches facilitate synthesis of multiple sources of data to update probabilities of focal outcomes of interest after examining new data (i.e., a `prior', which is a probability distribution that represents the modeler's pre-existing beliefs or knowledge about a model parameter before any new data is considered, see Box 1). Bayesian methods are well-suited to decision making, as they move beyond strict null-hypothesis testing to provide a quantitative measure of the probability of a hypothesis being true given the available data. Some fields within conservation biology and natural resource management have adopted Bayesian methods (e.g., wildlife mark and recapture models or occupancy models \citep{Kery2011}, fisheries \citep{Doll2018}), but they have yet to be widely used across conservation biology and have not been integrated into many globally significant policy and management practices. 

% emw15Nov2025: can you make the first sentence stronger? Maybe: Here, we highlight the major features of Bayesian approaches that could aid conservation science and show how practitioners who are new these approaches can get started. I also think you could cut 1-2 sentences from this paragraph. 
Here,  we highlight the features of Bayesian approaches that are well-suited to conservation science for practitioners who may be unfamiliar with Bayesian methods. We first review some benefits of using Bayesian methods to address conservation science questions, focusing on three key features: the iterative workflow process, flexible modelling frameworks, and integration of uncertainty. We also share resources that we hope will make Bayesian methods more approachable to those who have not used them before, including example code and analyses through three case studies relevant to current conservation problems, and a list of resources to get started with these methods. Even if readers do not use Bayesian approaches themselves, we hope they will better understand why and how they can be beneficial. We hope to accelerate more widespread adoption of and comfort with Bayesian data analytical approaches, as the time is right for integration into conservation science, policy, and practice. 

\section* {Benefits of Bayesian Modelling for Conservation Science}
\subsection*{Iterative workflows for adaptive management}
\par As conservation scientists implement interventions in variable and dynamic ecosystems that often exhibit unexpected behaviors \citep{Levin2012,Gross2013}, the practice of adaptive management has become common \citep{holling1978adaptive} (Fig. \ref{fig:workflow}). Cycles of adaptive management include stages of \underline{assessing} threats and conservation goals, \underline{planning} strategies, implementation, and monitoring, \underline{implementing} those plans, \underline{analyzing} results of initial implementation, \underline{adapting} implementation based on these analyses, and \underline{sharing learning} from the process. This cycle of iteration continues until the end of the project, ideally when conservation goals are met, and the intention is for this evidence-based approach to lead to improved conservation outcomes (https://www.conservationbydesign.org/). % emw15Nov2025: If we need to save space, it seems like much of the text with the underlining in this paragraph and the next could be integrated into the figure and its caption. Either way, it might be helpful to show on figure 1 the original place that modeling shows up and clearly contrast it with the alternative using Bayesian approaches. 

\par Bayesian modeling's workflows also follow an iterative process, and provide opportunities to integrate model development much earlier into the adaptive management cycle. Major training resources for adaptive management often place data analysis late in the cycle, as visually represented in the Conservation by Design diagram shown in (Fig. \ref{fig:workflow}). This is a potentially probelmatic practice because problems with study design, data collection practices, or other issues may not be identified until after it is too late to make changes. We believe that integrating the modelling workflow throughout the cycle would lead to valuable insights earlier in process, result in more robust conservation science and, perhaps, then better outcomes after implementation. Model development can occur in the \underline{assessing} stage, and be tested with simulated data in the \underline{planning} stage. Data collection occurs as part of monitoring during the \underline{implementing} stage and then models are run with empirical data as part of the \underline{analyzing} stage. Model checking and revising occurs during \underline{adapting} stages and then \underline{sharing learning} about modelling as well as conservation implementation occurs in parallel.  
...
\par Bayesian modelling approaches are well-suited to address the complexity and incomplete nature of many conservation datasets, given their flexibility and power to provide robust estimates under a wide range of conditions (e.g., Case Study 1). Bayesian models can be specified to include a wide range of data distributions via ready-to-use packages in programs like R (e.g., `brms'), and expanded to infinite  model specifications. Multiple sources and types of data can be amalgamated into Bayesian Belief Networks \citep{marcot2001using,newton2007bayesian}, and extant information can be used to inform `prior distributions' used in Bayesian modelling \citep{o2008informed,mcneish2016using}. (For more on what `prior distributions' or `priors' are, see Box 1.) As such, Bayesian methods can enable, social, biological, and physical data to be used to inform conservation decisions. 
Bayesian methods are also better than frequentist methods at accommodating the small population sizes that are often at high risk of extinction and thus are often a focus of conservation \citep{stinchcombe2002influence}. % Because Bayesian methods do not rely on asymptotic behavior (as frequentist statistics do \citep{mcneish2016using}), they are better able to accommodate small sample sizes. % emw15Nov2025: Given the audience I would avoid 'asymptotic' -- maybe just delete the sentence? %HNE17nov2025: agreed. I commented out that sentence, and added 'frequentist' to the prev sentence. 

% emw15Nov2025: We could problem either cut the whole text on NHT and p-values or shorten it to one sentence. So either cut:
% Bayesian methods thus can help move beyond `null hypothesis' frameworks and a focus on p-values, which have long dominated research in conservation biology, as in ecology and related biological fields \citep[e.g., ecotoxicaology][]{erickson2020moving}, but can lead to incorrect decisions (CITES). Because of their problems, p-value-focused conventions are becoming less prevalent, but many biologists are unsure of alternative ways to analyse and interpret their data \citep{halsey2019reign}. 
% Or shift to ...
% Bayesian methods thus can help move beyond `null hypothesis' frameworks and a focus on p-values, which have long dominated research in conservation biology \citep[as in ecology and related biological fields, e.g., ecotoxicaology][]{erickson2020moving}, but are  becoming less prevalent given they can lead to incorrect decisions \citep{halsey2019reign}. 
%HNE16nov2025: I like Lizzie's change to one sentence ("shift to", above). I think this info shoudl be kept, but fine to shorten. 
\par The flexibility of Bayesian methods is also well-suited to conservation planning because they facilitate comparison of support for a variety of hypotheses or interventions \citep{Zyl2018}.  Bayesian methods thus can help move beyond `null hypothesis' frameworks and a focus on p-values, which have long dominated research in conservation biology, as in ecology and related biological fields \citep[e.g., ecotoxicaology][]{erickson2020moving}, but can lead to incorrect decisions. Because of their problems, p-value-focused conventions are becoming less prevalent, but many biologists are unsure of alternative ways to analyse and interpret their data \citep{halsey2019reign}. Bayesian approaches and workflows offer an alternative framework, facilitating, for example, assessments of which interventions will result in greater conservation gains \citep{prato2005bayesian}, whether the current versus alternative management practices produce similar results \citep{gallistel2009importance}, and whether a population has passed a particular threshold, such as declining `rapidly' versus `moderately', as defined by a particular probability \citep{brooks2008quantifying}. The flexibility and power of Bayesian modelling require training to implement, as well as thoughtful specification and careful interpretation. We believe this is not unique to Bayesian modelling; rather it is applicable to all statistical tools and approaches.
...
% emw15Nov2025: If you need a ref for 'intuitive' the last chapter of BDA is compelling for this. 
\subsection*{Quantifying and propagating uncertainty} 
\par  Many conservation problems require integrating and propagating uncertainty across multiple datasets, multiple sources and/or multiple modeling steps (see Case Study 2). Bayesian approaches enable straightforward quantification and  propagation of  uncertainty \citep[e.g.,][]{stern2022interweaving, draper1995assessment,gilbert2023propagating} that is intuitive (e.g., posteriors of estimates from different sources can be added and averaged yielding new means, standard deviations etc.). This makes it easier for non-statistician colleagues and decision-makers to engage in the modeling step (cite our new adaptive mgmt figure?) \citep{fornacon2021bayesian}. This is also helpful for some conservation problems that can require analyses for which frequentist statistics are unable to compute the associated uncertainties \citep{bolker2009a,bates2006r}.   \cite{Eyster2022} provide an example of using Bayesian methods to estimate and propagate uncertainty to inform conservation decisionmaking that would be difficult using frequentist approaches. They used Bayesian methods to estimate the abundance of birds in different types of management landscapes (traditional agriculture, perennial polycultures) and then propagated the uncertainty associated with those abundances into a downstream analysis to test whether the bird communities in the alternative perennial polyculture landscape are maintained as an ecological sink or whether they truly support bird populations. % emw15Nov2025: Can we add a sentence to explain why this is great (I think it is buried in 'the alternative perennial polyculture landscape' ... so we mean 'This showed the the alternative perennial polyculture landscape ... '?) or reference a case study or figure? It would also be a nice transition if you could say:  \cite{Eyster2022} provide an example of using Bayesian methods to estimate species abundances that would be difficult using frequentist approaches ... 
%HNE16nov2025: tried to revise the sentences to address Lizzie's comments. 
...
\par Though Bayesian methods are increasing, they are not yet standard, widely used approaches that are well-integrated into national or global systems of conservation and climate science, policy and practice (e.g., IPCC, IUCN). For example, IPCC-described methods for uncertainty propagation do not include Bayesian approaches \citep{ipcc2007}, though these approaches would offer straightforward implementation (e.g., for propagating uncertainty, Case Study 2). As biological feedbacks are increasingly integrated into the climate/biophysical analyses that dominated early IPCC work, we believe the need for more streamlined and integrated approaches---offered by Bayesian modelling---have become more apparent. 

% emw15Nov2025: Wondering if we want to sneak in quick intro of observation and process in this paragraph? We might then change:
% Often this is because certain modeling approaches that are most easily fit through Bayesian inference have become standard in these fields. 
% -->>
% Often this is because these fields have developed better estimates using modeling approaches that separate out the biological process from the observations, and such approaches are most easily fit through Bayesian inference. 
\par Uptake and use of Bayesian methods is also highly variable across disciplines, suggesting opportunities to test their utility in fields where they are less used. For example, fisheries and wildlife biology generally have used Bayesian approaches more often than forestry and plant ecology (Fig. \ref{fig:consbaystrend}). Often this is because certain modeling approaches that are most easily fit through Bayesian inference have become standard in these fields. For example, mark-and-capture models within wildlife biology \citep[e.g.,][]{royle2013spatial,calvert2009hierarchical},  fisheries stock assessment approaches that integrate over different observational datasets to give the best estimates \citep[e.g.,][]{punt1997fisheries}. 
 % emw15Nov2025: nice point below!
...
\section* {A future with more widespread use of Bayesian modelling in conservation}
 % emw15Nov2025:  Can we say 'approaches' and 'Bayesian' a couple fewer times below?
\par The urgency of conservation problems and complexity of  ecological systems requires flexible, powerful modelling approaches, a challenge with which many traditional approaches (e.g., $t$-tests) struggle. Integrating Bayesian modelling approaches in conservation training and practice could help meet this challenge. If conservation and ecology students, across undergraduate and graduate levels, received analytical training that included strong foundations in Bayesian statistics they could more easily integrate many of the data, modeling, and uncertainty challenges into adaptive management (cite Fig). We argue the time to make this change is now, as Bayesian modelling has become easier given increased access to computational resources and training (see, e.g., Resources to Get Started). Further, given the utility and increasing use of Bayesian approaches (Fig. \ref{fig:consbaystrend}), we believe that the IPCC, IUCN and other global institutions should include Bayesian approaches as accepted options. These flexible and powerful approaches can help us develop more robust understanding of complex ecological systems, and facilitate fuller use of the data we have to address urgent conservation problems under climate change.
 ...
 % emw15Nov2025: Would be great to add to intro!
...
\par In some cases, Bayesian approaches can lead to different conclusions than common Fisherian approaches, such as null hypothesis testing \citep{wade2000bayesian}. Consider, for example, sampling five populations of a species across its range---from north to south---to monitor for changes in the population size with climate change. 
 % emw15Nov2025: Do we want to sneak in a sentence about leading edge and trailing edge expectations? I can if we have space...
After collecting data for ten years, a traditional null hypothesis testing approach to analyzing the data, using the commonly used significance level ($\alpha$) of 0.05 would find changes in only two of the populations---the furthest north population, which appears to be increasing, and the second furthest north population, also increasing. The three other populations are not significantly changing under this approach (Fig. \ref{fig:nht} left). In contrast, a Bayesian approach (using weakly informative priors centered at zero, all code provided in supplement) would likely focus on the full distribution of the modeled estimates (the posteriors), where small differences in the variance do not appear so different  (Fig. \ref{fig:nht} right). Here, a clear trend emerges where trends in population size correlate with position in range---with the most northern population increasing the most and the most southern population decreasing the most. This pattern across the range is the type predicted by climate change and may be missed with a classic Fisherian approach (combining null hypothesis testing with threshold values for `significance'), leading to potential very difference conservation and management decisions. % EMW says: We could also add (1) more details on the simulations (the variance in the underlying model increases going from north to south, which is expected for smaller population sizes), (2) point out 10 years is often more years than we have; though I think there is enough text already. 


\subsection*{Case Study 2: Incorporating and propagating uncertainty}

\par One major approach that integrates biodiversity conservation and climate change mitigation is `natural climate solutions' (NCS) \citep{ellis2024principles}, also called nature-based climate solutions. NCS are intentional human actions (or `NCS pathways') that protect, restore, and improve management of forests, wetlands, grasslands, oceans, and agricultural lands to mitigate climate change \citep{griscom2017natural}. Estimating mitigation potential of NCS involves multiple sources of uncertainty, many of which are not incorporated in commonly used approaches. We simulate flux data from a field study quantifying methane fluxes in peatlands with and without grazing in Ecuador \citep{sanchez2017carbon} to show how Bayesian approaches can be used to propagate uncertainty from area, as well as fluxes, in a straightforward way (Fig.\ref{fig:ncs}).  % emw15Nov2025: explain 'from area' a little more?

\subsection*{Case Study 3: State-space model and priors example}  % emw15Nov2025: Text still needs some work for this case study?
...
\par 
\section* {Box 1}
\subsection{Defining Bayesian Analysis} %HNE I think remove this parenthetical, and add below (i.e., Inference and Workflow)}

Bayesian analysis, including inference and workflow, enable us to combine prior knowledge of a system with available data to quantitatively measure the probability of a model or hypothesis being true. A Bayesian model treats parameters as random variables for which a known probability distribution is defined based on prior knowledge of the parameter uncertainty. By incorporating expert knowledge of ecological processes or species natural history, this modelling approach allows the development of bespoke and uniquely formulated models for any given data-generating process.\\  % emw15Nov2025: pick one of 'bespoke and uniquely formulated'
...
\begin{align}
 ...
 % emw15Nov2025: Can we sneak in a definition of 'inference'?
...
Our aim here is not to provide an exhaustive explanation of Bayesian statistics, but to provide a brief introduction of core components of a Bayesian model and their relationships. For an in depth discussion of Bayesian statistics, we recommend the \emph{Gentle Introduction to Bayesain statistics} by \cite{van2014gentle}, \emph{Bayesian model selection for ecologists} by \cite{hooten2015guide}, and \emph{Bayesian Inference for ecologists} by \cite{ellison2004}. For further discussion of prior selection for ecological models, see \cite{banner2020priors}.
%HNE13nov2025 What's the rationalle for removing the items below? They seem helpful? 
...
% 
 ...
 \subsection{Resources to Get Started}
%\par Note that this will be merged in with Box 1.
%HNE13nov2025: do we want to set these all up to be citations and in the reference list? 

\par Resources on general Bayesian methods: 

Uptick in the use of Bayesian inference has come alongside new programming languages that have made Bayesian models easier and faster to fit \citep{Carpenter:2017stan}, and we thus focus many of our recommendations on materials that use these newer approaches. We provide only a short list, and encourage researchers new to Bayesian to try new or updated materials as they become available. Additionally, a number of the below recommendations now have their materials online, and include videos of lectures (e.g., see websites by McElreath and Vehtari) for courses that go with the books and can help with learning the material. 

\begin{itemize}
\item Statistical Rethinking by Richard McElreath \url{http://xcelab.net/rm/statistical-rethinking/} is likely a major reason for the increasing use of Bayesian inference in ecology and is a great read.
\item \emph{Regression and Other Stories} (ROS) by Gelman, Hill \& Vehtari (\href{https://avehtari.github.io/ROS-Examples/}{more info here, including ROS online PDF}) is a great resource for learning Bayesian approaches that starts at the very beginning and builds up almost to multi-level modeling. It is effectively the first half of \emph{Data Analysis Using Regression and Multilevel/Hierarchical Models} by Gelman \& Hill \href{http://www.stat.columbia.edu/~gelman/arm/}{(more info here)} but updated to modern approaches and our current understanding of priors, workflows and more. 
 % emw15Nov2025: I don't know the below but people seem to like them, maybe someone else can add here? 
\item Bayesian Models: A statistical primer for ecologists by Hobbs \& Hooten
 \item Ecological Forecasting by Dietz
\item Applied statistical modelling for ecologists: a practical guide to Bayesian and likelihood inference using R, JAGS, NIMBLE, Stan and TMB by Marc K\'ery
and Kenneth F Kellner
\item \emph{Bayesian Data Analysis} (sometimes called `BDA') has also popularized Bayesian inference and is a great resource for those who want to learn from the underlying math and have a resource that covers many approaches. 
\item Michael Betancourt has most of what will become a book important concepts in probabilistic modeling  \href{https://betanalpha.github.io/writing/}{online}. It builds up from the mathematical foundations to a number of useful modeling approaches with careful case studies throughout. 
\item Many of the above resources discuss different versions of a Bayesian workflow, which is also highlighted in several papers  \citep{gelman2020bayesia}
% Add to above bullet?: Visualization in Bayesian Workflow \url{https://doi.org/10.1111/rssa.12378} % add ref? 
% Add to above bullet?: A four-step Bayesian workflow for improving ecological science \url{https://doi.org/10.48550/arXiv.2408.02603}
 \end{itemize}

For many the best way to start or advance in Bayesian inference is through building community. This may mean starting to learn Bayesian approaches in reading or model building group, and is how many of us learned---picking a book and finding a group that wants to meet weekly (or twice monthly) to work through the chapter concepts and exercises together, or having a group where each person reports on a model they're working on each time (this works best when not everyone is new to Bayesian inference). This can also work to go through a suite of case studies (e.g., \url{https://mc-stan.org/learn-stan/case-studies.html}, \url{https://github.com/stan-dev/example-models}). 

These communities can be in-person, over Zoom and can extend through a suite of virtual forums. Many questions are posted and answered through The Stan Forums \url{https://discourse.mc-stan.org/} for example, and the community hosts annual conferences as well. In additional conferences for statistical ecology societies, Bayesian statistics societies, and for R and Python can often be great places to meet people interested in these approaches. 


\begin{itemize}
 \item  \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4158865/}{Gentle Introduction to Bayesian statistics \citep{van2014gentle}}
 \item Bayesian Inference for ecologists. \citep{elis2004} % emw15Nov2025: Do we want these older refs? I would skip them. 
\item Bayesian statistics and modelling \url{https://doi.org/10.1038/s43586-020-00001-2}
\item The Stan Forums \url{https://discourse.mc-stan.org/} % emw15Nov2025: I integrated above, see what you think. 
 \item Why becoming Bayesian? \citep{clark2005environmental}  % emw15Nov2025: Do we want these older refs? I would skip them. 
  \href{https://doi.org/10.1111/j.1461-0248.2004.00702.x}{https://doi.org/10.1111/j.1461-0248.2004.00702.x}

 \end{itemize}

\par Bayesian case studies: % emw15Nov2025: I integrated above, see what you think. 
\begin{itemize}
\item Stan Case Studies \url{https://mc-stan.org/learn-stan/case-studies.html}
\item Stan Example Models \url{https://github.com/stan-dev/example-models} 
\end{itemize}

 \par Resources on priors: % emw15Nov2025: Skip?
 \begin{itemize}
 \item Banner et al. 2020 \url{https://doi.org/10.1111/2041-210X.13407}
\item Northrup \& Gerber 2018. \url{https://doi.org/10.1371/journal.pone.0192819}
\item Stan Prior Recommendations \url{https://github.com/stan-dev/stan/wiki/Prior-Choice-Recommendations}
 \end{itemize}

 \par Bayesian model simulation, validation, and checking:
 \begin{itemize}
 \item \href{https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecm.1314}{A guide to Bayesian model checking for ecologists \citep{conn2018guide}} % emw15Nov2025: I personally dislike this paper -- be sure to read it before you cite it... or maybe we skip this sub-category entirely?
 \item 
  \href{https://doi.org/10.1890/14-0661.1}{Bayesian model selection for ecologists. \citep{hooten2015guide}}
\item Beginning exercise in simulating data \url{https://bios2.github.io/biodiversity_modelling_2021/exercise_questions.html}
\end{itemize}
...
%13nov2025: I reordered -- how does that look? 
