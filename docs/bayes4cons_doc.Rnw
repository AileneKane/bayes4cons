...
% 
 ...
 \section* {Resources to Get Started}
\par Note that this will be merged in with Box 1.
 ...
 \item 
 \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4158865/}{Gentle Introduction to Bayesian statistics \citep{van2014gentle}}
 \item 
