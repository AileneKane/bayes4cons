...
This species has a long life span (20+ years) and creates long term pairs that can produce maximum 2 offspring when in good conditions, and therefore could be able to almost double in size every year. Here the conservation area does not allow the animal to fulfill its full growth ($\beta_0 = 1.3$). From a repeated assessments of the efficiency of the line transect in early years, when all of the re-introduce animals were individually marked, we know that we can miss many individuals and have estimated the $\sigma_o = 10$. We know that for most population of this species, the birth rate, which is the main source of biological stochasticity, vary by less than 5%.
